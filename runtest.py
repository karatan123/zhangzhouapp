...
# suite.addTest(test_personmanagement.PersonmanagementTest('test_personmangement_swip'))
...
suite.addTest(test_customermanagement.CustomermanagementTest('test_customermanagement_edit'))
