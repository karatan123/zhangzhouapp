...
class VehiclesmanagementTest(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        desired_caps = {}
    ...
    def test_vehiclesmanagement_existsearch(self):
        ...
        time.sleep(5)
        result = self.driver.find_element_by_id("com.locision.recycling:id/tv_name")
        self.assertIn("闽Y88888", result.text)
        #     清除搜索框内容
        searchinput.clear()
